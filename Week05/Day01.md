...
Productive Platforms (Quarterly): Shared capabilities (eg, ingestion, eval harness, retrieval); multiteam leverage.
...
Stop-Loss: Pre-commit to kill/pivot thresholds (e.g., reliability <98% for 2 consecutive months).
...
Finalize three investment cases and submit G2 asks (pilot) with Budget NTE and dates.

Publish portfolio wall and IC calendar.

Schedule month-end IC pack review with CFO/Chair.
